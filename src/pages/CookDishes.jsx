...
const CookDishes = () => {
  ...
  const categories = [
    ...
    { value: 'entree', label: '🥗 مقبلات' },
    { value: 'patisserie', label: '🍰 حلويات ومعجنات' },
    { value: 'boisson', label: '🥤 مشروبات' },
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <button
            ...
            className="bg-orange-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-orange-700 transition shadow-md"
          >
            + إضافة طبق جديد
          </button>
        </div>
            ...
            {dishes.map((dish) => (
              <div
                ...
                className={`bg-white rounded-2xl shadow-md overflow-hidden border-2 ${
                  dish.available ? 'border-green-200' : 'border-gray-200 opacity-60'
                }`}
              >
                {dish.photo && (
                  <img
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="bg-blue-100 text-blue-700 px-3 py-2 rounded-lg hover:bg-blue-200 transition text-sm font-bold"
                    >
                      ✏️ تعديل
                    </button>
                    <button
