...
export default function Navbar() {
  ...
  const hideOnRoutes = ['/login', '/cook/signup', '/customer/signup', '/cook-invite'];
      ...
      >
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 active:scale-95 transition-transform">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/30 overflow-hidden">
              <img
                src="/nakha-logo.png"
                alt="نَكهة"
